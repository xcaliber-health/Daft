...
class DaftServeServer:
    def __init__(
        ...
        tenants: list[tuple[str, str, int | None, int | None, int | None, int | None, int | None]] = ...,
    ...
    def wait(self) -> None: ...
    def shutdown(self, drain_timeout_secs: int = 120) -> None: ...

class DaftServeServerInfo:
    @property
    def version(self) -> str: ...
    @property
    def plan_payload_enabled(self) -> bool: ...
    @property
    def max_concurrent_queries(self) -> int: ...
    @property
    def max_pset_bytes(self) -> int: ...
    @property
    def catalogs(self) -> list[str]: ...

class DaftServeQueryResult:
    @property
    def optimized_locally(self) -> bool: ...
    def __iter__(self) -> DaftServeQueryResult: ...
    def __next__(self) -> PyMicroPartition: ...
    def stats(self) -> tuple[str | None, PyExecutionStats] | None: ...

class DaftServeClient:
    ...
    def explain_plan(self, builder: LogicalPlanBuilder) -> str: ...

def serve_referenced_pset_keys(builder: LogicalPlanBuilder) -> list[str]: ...
...
class PyDaftExecutionConfig:
    ...
    @property
    def enable_scan_task_row_group_splitting(self) -> bool: ...
    @property
    def enable_spilling(self) -> bool: ...
    @property
