                        ...
                        while let Some(result) = stream.next().await {
...

                            {
                                ...
                                match *remaining {
                                    ...
                                    // Note: Due to parallel glob execution, multiple tasks may read
                                    // data concurrently before detecting limit is met. This can result
                                    // in slightly more rows than the limit. This is acceptable for
                                    // performance reasons.
                                    Some(rows_left) => {
                                        let new_remaining =
